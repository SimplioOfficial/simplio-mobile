...
export default {
  ...
  SELECT_CRYPTO: 'Select coin',
  CREATE_WALLET_FIRST: 'Create new wallet for the selected coin first',
  MOBILE_NUMBER: 'Mobile number',
  FIVE_DIGIT_CODE: '5-digit code',
  KYC_SMS: 'Please enter the 5 digit verification code you have received to your phone.',
  KYC_EMAIL: 'Please enter the 5 digit verification code you have received to your email.',
  PAYMENT_SUCCESS_TITLE: 'Your payment was successful',
  PAYMENT_FAILURE_DESC: 'Please contact support for further information',
