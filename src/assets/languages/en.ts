...
export default {
  ...
  ACCOUNT_PASSWORD_IS_USED_TO_LOG_INTO_YOUR_SIMPLIO_WALLET_ACCOUNT_TOGETHER_WITH_YOUR_EMAIL:
    'Account password is used to log into your BitFrost account together with your email.',
  ...
  MASTER_PASSWORD_IS_THE_MOST_IMPORTANT_PASSWORD_TO_CONTROL_SIMPLIO_WALLET:
    'Master Password is the most important password to control BitFrost. Keep it on safe place!',
  ...
  WELCOME_TO_SIMPLIO_WALLET: 'Welcome to BitFrost',
